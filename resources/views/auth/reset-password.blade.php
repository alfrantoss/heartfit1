...
<head>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        :root{--green:#28a745;--text:#1a202c;--muted:#718096;--border:#e2e8f0;--bg:#f0fdf4;--shadow:0 20px 60px rgba(40,167,69,.12)}
        ...
        .btn-toggle-pw{background:transparent;border:none;padding:0 14px;color:var(--muted);cursor:pointer;font-size:18px;transition:color .2s}
        .btn-toggle-pw:hover{color:var(--green)}
...
<div class="auth-wrapper">
    <div class="auth-card">
        <div class="auth-header">
            ...
            <div class="auth-header-title">Buat Password Baru 🔒</div>
            <div class="auth-header-sub">Masukkan password baru yang kuat</div>
        </div>
        <div class="auth-body">
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control" name="email"
                               value="{{ old('email', $email) }}" placeholder="Email terdaftar" required/>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" id="pw1" class="form-control" name="password"
                               placeholder="Min. 6 karakter" required oninput="checkStrength(this.value)"/>
                        <button type="button" class="btn-toggle-pw" onclick="togglePw('pw1',this)">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" id="pw2" class="form-control" name="password_confirmation"
                               placeholder="Ulangi password baru" required/>
                        <button type="button" class="btn-toggle-pw" onclick="togglePw('pw2',this)">
                            <i class="bx bx-hide"></i>
                        </button>
                    </div>
                </div>
...
function togglePw(id, btn) {
    ...
    ic.className = el.type === 'text' ? 'bx bx-show' : 'bx bx-hide';
}
function checkStrength(pw) {
    ...
    const L = [{w:'0%',bg:'#e2e8f0',l:''},{w:'25%',bg:'#e74c3c',l:'Sangat lemah',c:'#e74c3c'},{w:'50%',bg:'#f39c12',l:'Lemah',c:'#f39c12'},{w:'70%',bg:'#3498db',l:'Cukup',c:'#3498db'},{w:'85%',bg:'#27ae60',l:'Kuat',c:'#27ae60'},{w:'100%',bg:'#1e7e34',l:'Sangat kuat',c:'#1e7e34'}];
    const lv = L[s] || L[0];
